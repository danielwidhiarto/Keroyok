    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-background to-muted px-4">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold tracking-tight">Keroyok</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Post masalah, AI match ke orang tepat, komunitas keroyok bareng
          </p>
        </div>

        <Button className="w-full gap-3" size="lg" onClick={handleGoogleLogin}>
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground">
          Dengan masuk, kamu setuju untuk saling bantu dan berbagi ilmu 🤝
        </p>
      </motion.div>
    </div>
  );
